...
/** A block to be executed whenever an error occurs while picking a photo. Use this block to replace delegate method photoPickerController:failedPickingPhotoWithError: */
...
- (void)photoPickerController:(DZNPhotoPickerController *)picker failedPickingPhotoWithError:(NSError *)error;
